...
public:	//interface
	...
	Student(const Student& obj) { this->copy(obj); student_count_++; }
	...
	int homework(const size_t index) const;					//get value of indexed homework
	...
	void setFinalMark();														//set final mark

	//other functions
	Student& copy(const Student& it);	//copeis values from another student
	...
	void print(std::ostream& out);		//print information about the student

	//sorts homework in ASCENDING order
	inline void homeworkSort() { sortHw_(); }											//sort homework in ascending order

	//TRUE for ascending, FALSE for descending
	inline void homeworkSort(const bool& ascendingOrder) { sortHw_(ascendingOrder); }	//sort homework
