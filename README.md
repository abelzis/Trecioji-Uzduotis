...
# Changelog
### [v0.5-deque](https://github.com/abelzis/Antroji-Uzduotis/releases/tag/v0.5-deque) (2019-03-01)
**Koreguota**
  - Pakeistas `std::vector` konteinerio tipas į `std::deque`.
  - Ištrinta galimybė naudoti `C-array` tipo konteinerį.
